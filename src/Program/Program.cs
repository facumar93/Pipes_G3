    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            IPipe pipeProvider2 = new PipeSerial(filterProvider, pipeNull);
            IPipe pipeSerial2 = new PipeSerial(filterNegative, pipeProvider2);
            IPipe pipeTwiter1 = new PipeSerial(filterTwiter, pipeNull);
            IPipe pipeConditionalFork1 = new PipeConditionalFork(filterConditional, pipeTwiter1, pipeSerial2);
            IPipe pipeProvider1 = new PipeSerial(filterProvider, pipeConditionalFork1);
            IPipe pipeSerial1 = new PipeSerial(filterGreyscale, pipeProvider1);
